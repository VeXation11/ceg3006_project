...
Xin Ru – System Concept & Ideation
I contributed primarily during the ideation and concept development phase of the PPAS-P system. Using AI tools such as ChatGPT, I explored multiple Vehicle-to-Pedestrian (V2P) safety concepts and helped the team identify occlusion as a key real-world problem worth addressing. I evaluated AI-generated ideas critically, selecting only those that were feasible and relevant to urban environments. I also participated in refining the system objective from a basic proximity alert system to a predictive safety solution using trajectory estimation. Through this process, I learned the importance of not relying solely on AI suggestions but validating them through engineering reasoning. Additionally, I supported early documentation and ensured that our concept aligned with project requirements. Overall, my contribution helped shape the direction and uniqueness of our solution.

Jun Qi – System Architecture Design
My main role was designing the system architecture and defining how different components interact within the PPAS-P system. I used AI assistance to structure the architecture into subsystems such as pedestrian devices, V2P communication, vehicle OBU, and HMI. However, I refined these outputs to ensure proper data flow and realistic integration, as shown in the architecture diagrams. I ensured that communication between modules was logically consistent and aligned with real vehicular systems. I also worked on improving the clarity of diagrams and ensuring they met academic presentation standards. This process helped me understand how high-level concepts translate into structured system designs. I learned that AI is useful for structuring ideas, but human input is required to ensure technical correctness and completeness.

Isaac – Algorithm & Pseudocode Development
I was responsible for developing the system logic, including pseudocode for trajectory prediction, TTC calculation, and alert triggering. AI tools helped generate initial versions of the algorithms, but I identified that some outputs were oversimplified, particularly in TTC computation. I improved these by incorporating trajectory prediction and synchronization, as reflected in the pseudocode and flowcharts. I also defined threshold levels for different alert categories (low, medium, high risk). Through this, I gained a deeper understanding of how theoretical concepts are implemented into practical logic. I ensured that the final algorithms were consistent with real-time constraints and system requirements. This experience taught me how to critically refine AI-generated technical content into usable engineering solutions.

Benjamin – Communication & Hardware Parameters
My contribution focused on defining the communication system and hardware specifications for PPAS-P. I worked on selecting appropriate technologies such as C-V2X and defining realistic parameters including latency, bandwidth, and communication range. While AI provided initial values, I verified and adjusted them based on reliable references and project requirements, ensuring values like latency (20–100 ms) were realistic . I also helped structure tables for hardware components and system parameters, making the design more professional and technically sound. This role helped me understand the importance of validating AI-generated data, especially in engineering contexts. I learned that incorrect assumptions in parameters can significantly affect system feasibility. My work ensured that the system design remains practical and implementable.

Clifford  – Documentation & Integration
I was responsible for compiling and refining the overall documentation, including the README and system integration section. I used AI tools to improve clarity, grammar, and structure, but ensured that all content accurately reflected our actual design. I integrated contributions from all team members into a cohesive report, aligning sections such as architecture, pseudocode, and use case descriptions. I also ensured consistency between diagrams, explanations, and technical details. Additionally, I reviewed AI-generated content to identify weaknesses such as lack of context awareness and incomplete integration details, and corrected them accordingly. This role helped me develop strong technical writing and critical evaluation skills. I learned how to use AI responsibly as a support tool rather than a source of final answers.
